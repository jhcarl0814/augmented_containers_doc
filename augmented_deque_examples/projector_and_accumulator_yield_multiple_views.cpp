...
struct AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t)
{
    ...
    AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t)() = default;
    AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t)(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) const &other)
...
struct AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulating_group_by_binary_functor_t)
{
    ...
    AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) monoidal() const { return {}; }
    AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) operator()(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) lhs, AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_group_by_node_t) const &rhs) const;
    AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) operator()(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) lhs, AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) rhs) const;
};

struct AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_and_accumulator_group_by_t): AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_group_by_t), augmented_containers::augmented_deque_helpers::accumulator_wrapping_accumulating_binary_functor_t<AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulating_group_by_binary_functor_t)>
{};
...
std::size_t AUGMENTED_DEQUE_EXAMPLE_PREFIXING(calculate_group_by_s_key)(decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::element_t const &element)
{
    return (element % 3 + 3) % 3;
}
AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulating_group_by_binary_functor_t)::operator()(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) lhs, AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_group_by_node_t) const &rhs) const
{
    using namespace augmented_containers::detail::tagged_ptr_ns;
    auto iterator_projected_storage_rhs = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(&const_cast<AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_group_by_node_t) &>(rhs));
...
AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulating_group_by_binary_functor_t)::operator()(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) lhs, AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) rhs) const
{
    using namespace augmented_containers::detail::tagged_ptr_ns;
                ...
                .projected_and_accumulated_storage_to_string_converters =
                    ...
                    std::make_pair(
                        [](auto parameters) -> html_label_t
                        {
                            ...
                            auto iterator_projected_storage = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(&const_cast<AUGMENTED_DEQUE_EXAMPLE_PREFIXING(projector_group_by_node_t) &>(parameters.datum));
                        ...
                        [](auto parameters) -> html_label_t
                        {
                            ...
                            for(std::pair<std::size_t const, AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t)::record_t> const &record : parameters.datum.records)
                            {
                                ...
                                case accumulated_storage_node_type_t::digit_node_end_accumulated_storage:
                                {
                                    ...
                                    {
                                        auto iterator_projected_storage_front = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(tagged_ptr_bit0_unsetted(record.second.front));
                                        parameters.converter_generated_statements_back_inserter++ = edge_statement_t{{{
                                    ...
                                    {
                                        auto iterator_projected_storage_back = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(tagged_ptr_bit0_unsetted(record.second.back));
                                        parameters.converter_generated_statements_back_inserter++ = edge_statement_t{{{
                                ...
                                {
                                    auto digit_node = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::digit_node_t::from_accumulated_storage_address(&const_cast<AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) &>(parameters.datum));
                                    if(record.second.front != nullptr)
                                    {
                                        auto iterator_projected_storage_front = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(tagged_ptr_bit0_unsetted(record.second.front));
                                        parameters.converter_generated_statements_back_inserter++ = edge_statement_t{{{
                                ...
                                {
                                    auto tree_node = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::tree_node_t::from_accumulated_storage_address(&const_cast<AUGMENTED_DEQUE_EXAMPLE_PREFIXING(accumulator_group_by_node_t) &>(parameters.datum));
                                    if(record.second.front != nullptr)
                                    {
                                        auto iterator_projected_storage_front = decltype(AUGMENTED_DEQUE_EXAMPLE_PREFIXING(augmented_deque))::sequence_t<0>::iterator_projected_storage_t::from_projected_storage_address(tagged_ptr_bit0_unsetted(record.second.front));
                                        parameters.converter_generated_statements_back_inserter++ = edge_statement_t{{{
