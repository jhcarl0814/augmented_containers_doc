...
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_monotonic_predicate_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_monotonic_predicate_ ## id
#include "augmented_deque_examples/find_by_monotonic_predicate.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_monotonic_predicate_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_monotonic_predicate_interactive_ ## id
#include "augmented_deque_examples/find_by_monotonic_predicate.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX

#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_ ## id
#include "augmented_deque_examples/find_by_heap_predicate.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_interactive_ ## id
#include "augmented_deque_examples/find_by_heap_predicate.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX

#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_generator_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_generator_ ## id
#include "augmented_deque_examples/find_by_heap_predicate_generator.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_generator_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_generator_interactive_ ## id
#include "augmented_deque_examples/find_by_heap_predicate_generator.hpp"
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIXING
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
...
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_monotonic_predicate_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_monotonic_predicate_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_monotonic_predicate_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
  ...
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterator_element_output"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterator_element_output));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("find_by_monotonic_predicate"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(find_by_monotonic_predicate));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("update_range"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(update_range));
...
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_monotonic_predicate_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_monotonic_predicate_interactive_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_monotonic_predicate_interactive_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
...
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_heap_predicate_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
  ...
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterator_element_output"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterator_element_output));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("find_by_heap_predicate"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(find_by_heap_predicate));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("update_range"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(update_range));
...
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_heap_predicate_interactive_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_interactive_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
...
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_generator_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_heap_predicate_generator_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_generator_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
  ...
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterator_element_output"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterator_element_output));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("find_by_heap_predicate_generator"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(find_by_heap_predicate_generator));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("update_range"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(update_range));
...
#undef AUGMENTED_DEQUE_EXAMPLE_PREFIX
#define AUGMENTED_DEQUE_EXAMPLE_PREFIX find_by_heap_predicate_generator_interactive_
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING(str) "find_by_heap_predicate_generator_interactive_" str
#define AUGMENTED_DEQUE_EXAMPLE_PREFIXING(id) find_by_heap_predicate_generator_interactive_ ## id
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("sequences_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(sequences_count));
  emscripten::function(AUGMENTED_DEQUE_EXAMPLE_PREFIXING_STRING("iterators_element_count"), &AUGMENTED_DEQUE_EXAMPLE_PREFIXING(iterators_element_count));
