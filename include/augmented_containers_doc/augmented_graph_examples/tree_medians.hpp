        ...
        [&]<std::size_t... I>(std::index_sequence<I...>)
        {
            (..., [&]()
                ...
                if(part_index == I)
                {
                    ...
                    {
                        AUGMENTED_GRAPH_EXAMPLE_PREFIXING(iterators_edge)[0] = AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph).part<I>().non_local_search([]([[maybe_unused]] decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph)) *graph, [[maybe_unused]] decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::part_t<I>::cluster_t *cluster_parent, decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::it_vertex_t it_vertex1, decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::part_t<I>::cluster_t *cluster_child_left, decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::it_vertex_t it_vertex2, decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::part_t<I>::cluster_t *cluster_child_right, decltype(AUGMENTED_GRAPH_EXAMPLE_PREFIXING(augmented_graph))::it_vertex_t it_vertex3, int dummy_or_rake_or_compress) -> std::optional<bool>
                                                                         {
